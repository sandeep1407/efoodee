...
class Sub_SelfDelivery_Fragment(var selF_DELIVERY: Int) : Fragment() {
    ...
    private fun getDataForList() {
        if (Sub_All_Fragment.listSelfDelivery.size == 0) {
            val jsonObject = JSONObject()
            try {
                jsonObject.put(RestTags.ORDER_PROGRESS_STATUS, MyOrdersFragment.ORDERPROGRESSSTATUS)
                jsonObject.put(RestTags.SERVICE_TYPE, selF_DELIVERY)
            ...
            setAdapter(Sub_All_Fragment.listSelfDelivery, RestTags.SELF_DELIVERY_STR)
        }
                                        ...
                                        try {
                                            ...
                                            if (jsonObject != null && jsonObject.optInt("statusCode") == 200
                                                ...
                                                if (dataPojo != null) {
                                                    ...
                                                    setAdapter(
                                                        Sub_All_Fragment.listSelfDelivery,
