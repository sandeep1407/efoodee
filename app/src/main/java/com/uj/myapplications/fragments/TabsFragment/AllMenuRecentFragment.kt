...
import kotlinx.android.synthetic.main.fragment_all_menu_recent.*
 ...
 *
 */
class AllMenuRecentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_all_menu_recent, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        // Creates a vertical Layout Manager
        recyclerView_all_recent_menu.layoutManager = LinearLayoutManager(activity)
        recyclerView_all_recent_menu.hasFixedSize()
    ...
    fun setAdapter(menuList: MutableList<MenuDetailPojo>) {
        ...
        recyclerView_all_recent_menu.adapter = adapter
