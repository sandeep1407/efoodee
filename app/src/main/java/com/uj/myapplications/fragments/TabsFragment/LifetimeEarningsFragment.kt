...
import kotlinx.android.synthetic.main.fragment_earnings_all_layout.*
 ...
 *
 */
class LifetimeEarningsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_earnings_all_layout, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        // Creates a vertical Layout Manager
        recyclerView_my_earnings.layoutManager = LinearLayoutManager(activity)
        recyclerView_my_earnings.hasFixedSize()
        ...
        if (UtilityClass.isInternetAvailable(activity!!)) {
            ...
            //  getOrdersResponse(RestUrls.GET_MENU, jsonObject)
    ...
    fun setAdapter(menuList: MutableList<MenuDetailPojo>) {
        ...
        recyclerView_my_earnings.adapter = adapter
