...
import kotlinx.android.synthetic.main.fragment_all_menu_scheduled.*
...
class AllMenuScheduledFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_all_menu_scheduled, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        // Creates a vertical Layout Manager
        recyclerView_all_scheduled_menu.layoutManager = LinearLayoutManager(activity)
        recyclerView_all_scheduled_menu.hasFixedSize()
    ...
    fun setAdapter(menuList: MutableList<MenuDetailPojo>) {
        ...
        recyclerView_all_scheduled_menu.adapter = adapter
