...
import kotlinx.android.synthetic.main.fragment_edit_current_menu.*
 ...
 *
 */
class EditRecentMenuFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //Right now we are maintaining single layout
        return inflater.inflate(R.layout.fragment_edit_current_menu, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        // Creates a vertical Layout Manager
        recyclerView_current_menu.layoutManager = LinearLayoutManager(activity)
        recyclerView_current_menu.hasFixedSize()
        ...
        try {
            ...
            jsonObject.put(RestTags.TYPE, RestTags.RECENT)
    ...
    fun setAdapter(menuList: MutableList<MenuDetailPojo>) {
        ...
        val adapter = MutipleAdapter(activity!!, menuList, RestTags.RECENT)
        recyclerView_current_menu.adapter = adapter
